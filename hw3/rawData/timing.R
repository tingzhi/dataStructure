...
dat=read.csv("~/Documents/github/dataStructure/hw3/timingLinkedList.csv")
...
yrange <- range(dat$Time) # calculating the range of the variable circumference                    
...
title("Execution Time Performance Comparison")   # add legend              
