...
int main()
{
    ...
    printf ("Total Price should be zero:");
    ...
    printf("There should be two items: ");
    if (getNumItems(cart) == 2)
        printf("success.\n");
    else
        printf("FAIL.\n");
    
    printf("The total should be $13: ");
    if (getTotalPrice(cart) == 13)
        printf("success.\n");
    else
        printf("FAIL.\n");
    ...
    printf ("Shopping cart should not contain 'milk': ");
    if (containsItem(cart, milk) == -1)
        printf("success.\n");
    else
        printf("FAIL.\n");
    ...
    printf ("Shopping cart only contain one item: ");
    if (getNumItems(cart) == 1)
        printf("success.\n");
    else
        printf("FAIL.\n");

    printf ("The total should be $10: ");
    if (getTotalPrice(cart) == 10)
        printf("success.\n");
    else
        printf("FAIL.\n");
    ...
    printf ("Shopping cart should not contain 'avacado': ");
    if (containsItem(cart, avacado) > -1)
        printf("success.\n");
    else
        printf("FAIL.\n");
    
    printf ("Shopping cart should have two items: ");
    if (getNumItems(cart) == 2 )
        printf("success.\n");
    else
        printf("FAIL.\n");

    printf ("The total price should be $13: ");
    if (getTotalPrice(cart) == 13)
        printf("success.\n");
    else
        printf("FAIL.\n");
